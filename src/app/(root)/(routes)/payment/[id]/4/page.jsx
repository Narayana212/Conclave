...
const userSchema = z.object({
  ...
  phoneNumber1: z
    ...
    .max(10, "Invalid Phone Number"),
  fullName2: z.string(),
  email2: z.string().min(5, "Too short"),
  rollNumber2: z
    .string()
    .min(10, "Invalid Roll Number")
    .max(10, "Invalid Roll Number"),
...
export default function PaymentPage() {
  ...
  const onSubmit = async (data) => {
    try {
      setLoading(true);
      const body = { ...data};
      const response = await fetch("/api/threebooking", {
        method: "POST",
  ...
  return (
    <div className=" bg-[#290E13] items-start lg:justify-between pb-20 w-screen pt-36 flex flex-col lg:flex-row gap-5 px-10">
